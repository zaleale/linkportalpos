...
<head>
    ...
    <title>Link Portal | Pos Indonesia</title>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li <?= $this->uri->segment(1) == 'product_knowledge' ? 'class="active"' : '' ?>>
                    ...
                    <li <?= $this->uri->segment(1) == 'ems_posindo' ? 'class="active"' : '' ?>>
                        <a href="<?= site_url('ems_posindo') ?>">
                            <i class="fa fa-plane"></i> <span>EMS Posindo</span>
                        </a>
                    </li>
                    <li <?= $this->uri->segment(1) == 'customercomplain_handling' ? 'class="active"' : '' ?>>
                        <a href="<?= site_url('customercomplain_handling') ?>">
