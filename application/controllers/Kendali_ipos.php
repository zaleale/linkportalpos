...
class Kendali_ipos extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('kendali_ipos_m');
    }

    public function index()
    {
        $data['row'] = $this->kendali_ipos_m->get();

        $this->template->load('template', 'kendali_ipos/kendali_ipos_data', $data);
    }
