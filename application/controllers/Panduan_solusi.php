...
class Panduan_solusi extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('panduan_solusi_m');
    }

    public function index()
    {
        $data['row'] = $this->panduan_solusi_m->get();

        $this->template->load('template', 'panduan_solusi/panduan_solusi_data', $data);
    }
