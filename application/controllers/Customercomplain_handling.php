...
class Customercomplain_handling extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('customercomplain_handling_m');
    }

    public function index()
    {
        $data['row'] = $this->customercomplain_handling_m->get();

        $this->template->load('template', 'customercomplain_handling/customercomplain_handling_data', $data);
    }
