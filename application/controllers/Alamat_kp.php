...
class Alamat_kp extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('alamat_kp_m');
    }

    public function index()
    {
        $data['row'] = $this->alamat_kp_m->get();

        $this->template->load('template', 'alamat_kp/alamat_kp_data', $data);
    }
