...
class Lacakwesel extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('lacakwesel_m');
    }

    public function index()
    {
        $data['row'] = $this->lacakwesel_m->get();

        $this->template->load('template', 'lacakwesel/lacakwesel_data', $data);
    }
