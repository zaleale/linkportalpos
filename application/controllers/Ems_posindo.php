...
class Ems_posindo extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('ems_posindo_m');
    }

    public function index()
    {
        $data['row'] = $this->ems_posindo_m->get();

        $this->template->load('template', 'ems_posindo/ems_posindo_data', $data);
    }
